...
<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <a class="btn-getstarted" href="{{ route('customer.login') }}">Login</a>
    ...
    <main id="main">
            ...
            <div class="container-fluid" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ asset('website/assets/img/clients/client-1.png') }}" class="img-fluid"
                            alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ asset('website/assets/img/clients/client-2.png') }}" class="img-fluid"
                            alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ asset('website/assets/img/clients/client-3.png') }}" class="img-fluid"
                            alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ asset('website/assets/img/clients/client-4.png') }}" class="img-fluid"
                            alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ asset('website/assets/img/clients/client-5.png') }}" class="img-fluid"
                            alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ asset('website/assets/img/clients/client-6.png') }}" class="img-fluid"
                            alt="">
                    </div><!-- End Client Item -->
        ...
        <section id="stats" class="stats">
            ...
            <img src="{{ asset('website/assets/img/stats-bg.jpg') }}" alt="" data-aos="fade-in">
            ...
            <div class="container">
                ...
                <div class="row gy-4 align-items-center features-item">
                    ...
                    <div class="col-lg-7 order-1 order-lg-2 d-flex align-items-center" data-aos="zoom-out"
                        ...
                        <div class="image-stack">
                            <img src="{{ asset('website/assets/img/features-light-1.jpg') }}" alt=""
                                class="stack-front">
                            <img src="{{ asset('website/assets/img/features-light-2.jpg') }}" alt=""
                                class="stack-back">
                        </div>
                    </div>
                </div><!-- Features Item -->
                ...
                <div class="row gy-4 align-items-stretch justify-content-between features-item ">
                    <div class="col-lg-6 d-flex align-items-center features-img-bg" data-aos="zoom-out">
                        <img src="{{ asset('website/assets/img/features-light-3.jpg') }}" class="img-fluid"
                            alt="">
                    </div>
                ...
                <div class="isotope-layout" data-default-filter="*" data-layout="masonry"
                    ...
                    <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            <img src="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-1.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>App 1</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-1.jpg') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                            <img src="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-2.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>Product 1</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-2.jpg') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                            <img src="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-3.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>Branding 1</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-3.jpg') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            <img src="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-4.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>App 2</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-4.jpg') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                            <img src="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-5.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>Product 2</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-5.jpg') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                            <img src="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-6.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>Branding 2</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-6.jpg') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            <img src="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-7.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>App 3</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-7.jpg') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                            <img src="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-8.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>Product 3</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-8.jpg') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                            <img src="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-9.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>Branding 3</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="{{ asset('website/assets/img/masonry-portfolio/masonry-portfolio-9.jpg') }}"
                                    title="Branding 2" data-gallery="portfolio-gallery-branding"
                                    class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <article>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('website/assets/img/blog/blog-author.jpg') }}" alt=""
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <article>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('website/assets/img/blog/blog-author-2.jpg') }}" alt=""
                                    class="img-fluid post-author-img flex-shrink-0">
                                <div class="post-meta">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <article>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('website/assets/img/blog/blog-author-3.jpg') }}" alt=""
                                    class="img-fluid post-author-img flex-shrink-0">
                                <div class="post-meta">
