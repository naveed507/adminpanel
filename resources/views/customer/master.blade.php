...
@include('customer._partials._head');

<body class="with-welcome-text">
    <div class="container-scroller">

        <!-- partial:partials/_navbar.html -->
        @include('customer._partials._topnavbar');
        <!-- partial -->
        <div class="container-fluid page-body-wrapper">
            ...
            @include('customer._partials._sidebar')
            <!-- partial -->
            <div class="main-panel">
                ...
                @include('customer._partials._footer')
                <!-- partial -->
            </div>
            <!-- main-panel ends -->
        </div>
    ...
    @include('customer._partials._footerscripts')
    @yield('pagescripts')
